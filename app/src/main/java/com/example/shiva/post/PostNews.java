...
EditText news,areaText,useredit;
...
imag1=0;
        ...
        postNews.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(news.getText().toString().equals("") || areaText.getText().toString().equals(""))  {
    ...
    public  void function() {
       ...
       // SharedPreferences.Editor edio = shared.edit();
        ...
        if(!TextUtils.isEmpty(area))    {
            ...
            Model model = new Model(newsnow,userValue,area,currentDateTimeString);
            
            mReference.child(userValue).setValue(model);
